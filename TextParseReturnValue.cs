...
namespace Rampastring.XNAUI
{
    public class TextParseReturnValue
    {
        ...
        public static TextParseReturnValue FixText(SpriteFontBase spriteFont, int width, string text)
        {
        ...
        public static List<string> GetFixedTextLines(SpriteFontBase spriteFont, int width, string text, bool splitWords = true)
        {
